#include <ngsaipp/parallel/ThreadPool.hpp>
#include <chrono>
#include <vector>
...
ngsai::ThreadPool::split_range(size_t from,
                               size_t to,
                               size_t n_thread)
...
ngsai::ThreadPool::ThreadPool(size_t n_threads, bool debug)
    : queue_task(),
      queue_mutex(),
      queue_open(true),
      debug(debug)
...
ngsai::ThreadPool::~ThreadPool()
{}


size_t
ngsai::ThreadPool::getNThread() const
{   return this->threads.size() ; }


void
ngsai::ThreadPool::addJob(std::function<void()>&& task)
...
void
ngsai::ThreadPool::thread_routine()
{
...
void
ngsai::ThreadPool::lock_mutex_queue()
...
void
ngsai::ThreadPool::unlock_mutex_queue()
...
void
ngsai::ThreadPool::open_queue()
{   this->queue_open = true ; }


void
ngsai::ThreadPool::close_queue()
{   this->queue_open = false ; }


bool
ngsai::ThreadPool::isQueueOpen()
{   return this->queue_open ; }


bool
ngsai::ThreadPool::isDebugOn() const
{   return this->debug ; }


void
ngsai::ThreadPool::debug_print(const std::string& msg, std::ostream& out) const
{   if(this->isDebugOn())
